...
$(".trigger").click(function(){
	//$(this).toggleClass("active").next().slideToggle(100,"linear");
...
$(".trigger_blog").on("click",function(){
	...
	//$(this).toggleClass("activeb").next().slideToggle(100,"linear");
	if(!visible){
		$(this).toggleClass("activeb").next().show();
	} else {
...
$(".post_more").click(function(){
	...
	$(this).toggleClass("activep").next().toggle();
	return false;
});
});
